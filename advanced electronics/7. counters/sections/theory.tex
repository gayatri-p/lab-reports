...
The counting sequence corresponding to each input pulse is based on its binary representation in 4-bits (i.e. from 0000 to 1111). On supplying 15th pulse the counter reads 1111 (decimal 15). The next clock
